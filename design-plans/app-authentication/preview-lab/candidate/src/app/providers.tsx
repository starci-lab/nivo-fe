 ...
 * words the shipped sign-in screen uses are the words beside these two new screens rather than a
 * second copy that can drift. What IS new is `auth.vi.json` next door: `signUp` and `forgotPassword`
 * do not exist in the shipped catalogue yet, and Apply merges them into it.
 *
...
export const CandidateProviders = ({ children }: CandidateProvidersProps) => (
    <NextIntlClientProvider locale={DEFAULT_LOCALE} messages={{ ...base, ...authMessages }} timeZone={TIME_ZONE}>
