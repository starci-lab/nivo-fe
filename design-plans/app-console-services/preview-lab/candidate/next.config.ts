 ...
 * and merges `src/messages/console.vi.json` over it, so every word these screenshots seal is either
 * a word the app already ships or a word Apply will merge into that same file. The mechanism differs
