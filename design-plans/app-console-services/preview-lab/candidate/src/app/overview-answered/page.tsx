...
/**
 * The overview when every query answered with something.
 *
 * Sealed separately from the root only so the review chrome can address this state by name.
 *
...
export default OverviewAnsweredRoute
