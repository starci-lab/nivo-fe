...
/**
 * The app set with apps in it, and the catalogue under them.
 *
 ...
 *
 * TARGET: `apps/app/src/app/[locale]/apps/page.tsx` - ONE route for all four states of this
 * level.
 *
 * @returns The route.
 */
const AppsListedRoute = () => (
    <Tree
        ...
        render={defineContractComponent("sidebar-then-body-app", {
            ...
            body: defineContractComponent("console-body-main", {
                 ...
                 */
                page: defineLeafComponent("page", {}, () => <AppsPage state="listed" />),
            }),
        })}
    />
)

export default AppsListedRoute
