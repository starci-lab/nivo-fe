...
/**
 * The wallet showing what is in it and what is owed.
 *
 * There is no absent arm to seal: `myWallet` creates the row on first read, so a brand-new
 * account reads a real zero rather than nothing at all.
 *
    ...
    <Tree
        ...
        render={defineContractComponent("sidebar-then-body-app", {
            ...
            body: defineContractComponent("console-body-main", {
                 ...
                 */
                page: defineLeafComponent("page", {}, () => <WalletPage state="balance" />),
            }),
        })}
    />
)
