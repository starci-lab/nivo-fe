...
/**
 * The app set holding one app that is paid for and not yet built.
 *
 * THE ROW HAS NO BUTTON, and that needs no new shape: `identity-kind-status-action-row.action`
 * is already optional because a resource mid-provision has nothing anybody may do to it.
 * Holding that row is one of the three things this middle level does that neither the overview
 * nor a single-app page can.
 *
    ...
    <Tree
        ...
        render={defineContractComponent("sidebar-then-body-app", {
            ...
            body: defineContractComponent("console-body-main", {
                 ...
                 */
                page: defineLeafComponent("page", {}, () => <AppsPage state="standingUp" />),
            }),
        })}
    />
)

export default AppsStandingUpRoute
