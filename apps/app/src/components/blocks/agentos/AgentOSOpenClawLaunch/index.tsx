...
export const AgentOSOpenClawLaunch = (props: AgentOSOpenClawLaunchProps) => {
  const {
    workspaceId
  }: AgentOSOpenClawLaunchProps = props;
  ...
  const {
    trigger: issueLaunch
  } = useMutateIssueAgentWorkspaceAppLaunchSwr(workspaceId);
  const {
  ...
  return <AgentOSOpenClawLaunchBase launchState={launchState} workspaceId={workspaceId} detail={detail} labels={labels} onRetry={() => {
