...
import { AgentOSWorkspaceControlCenterBase, type AgentOSWorkspaceControlCenterState, type AgentOSWorkspaceControlCenterLabels, type AgentOSWorkspacePageState } from "./component";
...
export const AgentOSWorkspaceControlCenter = (props: AgentOSWorkspaceControlCenterProps) => {
  const {
    ...
    pageState,
    onSelectPageState
  }: AgentOSWorkspaceControlCenterProps = props;
  ...
  const {
    trigger: renewLaunch
  } = useMutateRenewAgentWorkspaceAppLaunchSwr(workspaceId);
  const {
    trigger: revokeLaunch
  } = useMutateRevokeAgentWorkspaceAppLaunchSwr(workspaceId);
