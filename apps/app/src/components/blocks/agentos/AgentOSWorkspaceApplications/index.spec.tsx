...
const labels = { section: "Apps", openclaw: "OpenClaw", n8n: "n8n", openclawDescription: "Chat", n8nDescription: "Automate", available: "Available", unavailable: "Unavailable", manage: "Manage", unavailableAction: "Unavailable", securityUpgradeRequired: "Upgrade required", unavailableDetail: "Not available", opening: "Opening", blocked: "Blocked", expired: "Expired", disconnected: "Disconnected" }
