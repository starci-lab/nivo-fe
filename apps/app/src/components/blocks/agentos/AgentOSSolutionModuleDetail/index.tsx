...
import { nivoQueryData, useQueryMyAgentosModuleInstallationSwr } from "@/hooks/swr";
...
const installationForWorkspace = (installation: AgentosModuleInstallationDetail | null | undefined, workspaceId: string): AgentosModuleInstallationDetail | null | undefined => {
...
export const AgentOSSolutionModuleDetail = (props: AgentOSSolutionModuleDetailProps) => {
  const {
    workspaceId,
    installationId
  }: AgentOSSolutionModuleDetailProps = props;
  ...
  const query = useQueryMyAgentosModuleInstallationSwr(workspaceId, installationId);
