...
export const ConsoleTopBar = (props: ConsoleTopBarProps) => {
  ...
  return <ConsoleTopBarBase brandLabel={t("brand")} contextLabel={t("title")} isDark={isDark} lightThemeLabel={t("theme.light")} darkThemeLabel={t("theme.dark")} localeControl={LanguageMenu} localeControlProps={{}} accountControl={AccountMenu} accountControlProps={{}} drawerControl={ConsoleNav} drawerControlProps={{
    mode: "mobile"
