...
const props: OverviewPageViewProps = {
    ...
    pulse: { signals: [
        { id: "apps", label: "Apps", phase: "answered", value: "Academy", caption: "Running" },
        { id: "agentos", label: "AgentOS", phase: "answered", value: "sales-ops", caption: "Ready" },
        { id: "domains", label: "Domains", phase: "failed", value: "—", caption: "Unavailable" },
        { id: "wallet", label: "Wallet", phase: "answered", value: "0 VND", caption: "No invoice", emphasis: "accent" },
    ] },
