...
import { AppsPageBase, type AppsPageViewProps } from "./component"

const props: AppsPageViewProps = {
    title: "Apps",
...
describe("AppsPage drawing", () => {
    ...
    it("keeps the supported catalogue continuation available when the owned set is empty", () => {
        const html = renderToStaticMarkup(<AppsPageBase {...props} owned={{ phase: "empty", label: "Your apps", note: "No apps yet" }} />)
