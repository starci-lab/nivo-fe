...
export const LANDING_COPY = {
  ...
  hero: {
    ...
    mapLabel: "Minh họa System of Responsibility", mapStatus: "Responsibility đang vận hành", mapKicker: "NIVO AGENTIC OS", mapTitle: "Growth Pipeline", mapOwner: "Owner: Founder · AI operator: Revenue Agent", mapFlow: ["Context", "Evidence", "Outcome"], proofTitle: "Verified outcome", proofBody: "3 cơ hội đã đủ evidence để quyết định"
  },
